...
export function Loader({ loading }: LoaderProps) {
  if (loading) {
    return (
      <>
        <div className="flex justify-center items-center fixed bg-gray-900 w-full h-full opacity-60"></div>
        <div className="flex justify-center items-center fixed w-full h-full ">
